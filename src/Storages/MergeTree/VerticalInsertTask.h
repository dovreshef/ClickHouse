...
public:
    ...
    /// Get column samples accumulated from vertical phase
    ColumnsWithTypeAndName & getVerticalColumnsSamples() { return vertical_columns_samples; }
...
private:
    ...
    void addVerticalColumnsSample(const Block & sample);
    ...
    NameSet vertical_columns_sample_names;
